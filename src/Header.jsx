                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="#">Pricing Here</a>
                            </li>
                        </ul>
                        <form className="d-flex form-search" role="search">
                            ...
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{ width: "62%" }}>
                                <li className="nav-item">
            ...
            <section id='header'>
                <div className='header1'>
                    <div className="left-head1">
                        ...
                        <a className="" aria-current="page" href="#">facebook / </a>

                        <a className="" aria-current="page" href="#">React</a>
                        <span id="public-btn">Public</span>
                    ...
                    <div className="right-head1">
                        ...
                        <button type="button" className="btn btn-secondary btn-sm"><svg viewBox="0 0 16 16" width="16px" height="16px" style={{ filter: "invert(1)" }} >
